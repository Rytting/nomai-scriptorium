Documentation of all Nomai Text

Key

Nomai text is typed exactly as it is written in the game, with each new paragraph indicating the next ‘swirl’. If a Nomai conversation branches out then it is shown with a new bullet point, and carries on the same as before. If the script branches out *again*, it is shown by this bullet point. For example:

Start point

Continuation of start point

- Primary branch 1

​		Continuation of primary branch 1
...
- Primary branch 2
  ...
  - Secondary branch 2
    ...
    Continuation of secondary branch 2



An ellipsis (...) between Nomai scripts indicates that the next script is closely related to the one before.

A dash (-) between Nomai scripts indicates that they are unrelated.

Two names of places inside curly brackets indicates the use of the ‘projection stones’ 

A ‘🎥’ symbol indicates the following Nomai text is from an audio recording.

---

下面是挪麦人名-性别对照表：

The numbers in parenthesis are, in order, conversations where this Nomai is recorded, conversations where this Nomai is mentioned but doesn't participate, and (just for Solanum) in-person conversations. The total appearances are summed up after that.
...
6/14 have at least 10 conversations or mentions. 
...
6/8 have at least 10 conversations or mentions. As a side note, Solanum's gender is only mentioned in the Ship's log, which implies Nomai grammar marks gender more strongly than just having gendered pronouns. 
...
​		PYE: You lack a sense of humour.
...
{Sun Station ~ Ash Twin}

YARROW: What happened? Did the Sun Station not fire?

PYE: It fired, Yarrow. But it failed. The sun barely responded; there were infinitesimally small surface-level changes, but they were barely visible, even to the third eye.
...
​		IDAEA: We’re well, Yarrow (Or as well as can be expected, given the circumstances), though 		disappointed. I may have disagreed with the exploding of the sun, but I never wished the 		device would fail. I’d hoped our terrible work was finished.
...
ANNONA: This is a relief, at least. You have my gratitude. Bur, were you able to find the other escape pod's distress signals?
...
🎥 MELORAE: The heat from this star system's sun is more bearable beneath the surface.

MELORAE: When our escape pod punctured this planet’s surface, it broke into what scans show is a cave system with much cooler air. I *woul*d recommend we seek a site down there to build a long-term shelter, Annona, but these passages are a maze!

ANNONA: Even with this danger, they are still our best chance for survival. We'll form teams and descend into the caves to look for a shelter site. We can mark our findings on the wall to avoid becoming irreversibly lost.
...
MELORAE: We have found an enormous cavern at the end of this passage that appears promising! I believe we could construct long-term shelter here.
...
​		COLEUS: We both believe it's unlikely this dry planet is this horror's place of origin (especially 		considering what we observed during the Vessel's evacuation).
...
Should we build the Sun Station in order to power the Ash Twin Project?
...
​			IDAEA: The potential annihilation of and not entirely star system is too severe a cost. We 			shouldn't build the Sun Station, no matter how badly we want the knowledge that comes 			with it.

​			POKE: Fear of failure is a poor reason not to try. I believe, if we're cautious, the Sun 				Station will work. I believe in Pye.

​			PYE: Poke, I'm deeply honoured. Idaea, I comprehend your position; however, if we aren't 			all but certain the Sun Station will not cause destruction once we've built it, then I won't 			support the station's use.
...
LAEVI: Gratitude, Solanum! It's good you're small enough to climb through the hole at the Anglerfish Overlook.
...
LAEVI: We're meeting in the Fossil Fish Cave to play the game! If you're not too big to climb through the Anglerfish Overlook hole:

LAEVI: You'll have to go the long way, but it isn't far. Go to the Stepping Stone Cave, then up and into the Fossil Fish Cave.

TAGET: I tried to get to the Fossil Fish Cave through the Stepping Stone Cave, but I couldn't find the entrance. Where is it?

- ILEX: Remember to feed the fossil fish first! If you go into the Anglerfish Overlook and throw a light into his mouth, he'll show you the way.
...
- IDAEA: That would be Pye. I told her we wouldn't be travelling there by shuttle, and that the Sun Station doesn't even have a landing pad, but she said she knew.
...
​		LAEVI: Last anglerfish to be caught is the new anglerfish! (The old anglerfish gives the new 		anglerfish the blindfold and becomes a littlefish.)
...
- MELORAE: Visually, this specimen appears to be of the same species as the anglerfish in Dark Bramble. We don't believe it originated from this planet.
- COLEUS: This anglerfish's digestive tract suggests death by starvation.
- MELORAE: The long growth protruding from its head is bioluminescent. Perhaps it used this to attract prey (a lure?).
...
Be welcomed in this place. This shrine is a space to reflect on what brought us here to this star system: The signal from the Eye.

We observed the Eye's signal in our travels, and followed it here to find its source.

What we know is this: The source of the signal (which we have chosen to call the Eye of the universe) is older than the universe itself. The rest, we have yet to learn.
...
It could be naturally occurring, though this doesn't answer how old the Eye is.
...
RAMIE: Note: This door will need to remain closed for quite some time! Pye and I are running an experiment based on the extraordinary findings from the White Hole Station.
...
​		RAMIE: Inviting sand inside would disrupt our setup and could have enormous 						consequences. (We realise this is an intriguing prospect, but the door must remain closed 	nonetheless!)
...
PYE: Records show Nomai arriving at the warp receiver on Brittle Hollow very slightly before departing from the White Hole Station. Ramie and I are devising an experiment to test whether this is a real phenomenon or a simple machine error.

- RAMIE: In theory, what we want to try to reproduce is a negative amount of time elapsing between something entering the back hole and exiting the white hole at its destination.
...
​		RAMIE: Hypothesis: It is possible for an object to exit an white hole before entering the 			corresponding black hole.
...
- RAMIE: the energy is *currently* unavailable? You're a gas, Pye!
...
​		PYE: We also likely need an enormous space to fit these proposed new energy and warp 		technologies together. The only location large enough would be Ash Twin.

…

PYE: The Ash Twin Project will be one of our biggest undertakings (metaphorically *and* physically). To build it, we need a sound way to travel quickly between Ash Twin and each location that holds crucial project materials.

ROOT: What if we used warp towers (like the one we have on the white hole station) to connect each planet directly to Ash Twin?
...
​		PHLOX: we can design each warp tower to visually reflect its warp destination!

​		PHLOX: The Giant’s Deep tower, for instance, could resemble a cyclone. And we could add 		trees to the Timber Hearth tower!
...
- MELORAE: This is my first time encountering a natural satellite with the ability to vanish when not being watched. We should study it! Or, even better, we should travel there!
  ...
  - ANNONA: Given its reluctance to move while consciously observed, it might be a former of macroscopic quantum mechanics.
...
- ANNONA: You have keen eyes, my friend. So this moon travels to a total of five planets, not four.
...
​		MELORAE: It's also possible there exists also sixth place in this star system to which the 			phantom moon travels.



Southern Quantum Caves

MELORAE: This rock is very familiar! Did you travel here, my sedimentary friend? Because your unique colour and texture appears identical to a rock I met earlier.

MELORAE: wasn't this the same rock fragment in the cave we found at the bottom of the dry lakebed (at the north pole)?
...
MELORAE: Friends, if you find any sign of Coleus, I implore you to tell me! He vanished without a trace during our research trip, and he has been missing ever since.
...
​		MELORAE: You have my gratitude, Bur! Coleus and I were studying the cave’s geology. We 		hoped to learn more about a unique and wandering rock that visits several different caves 		in the area.

- ANNONA: Where was Coleus lost, Melorae?

​		MELORAE: He disappeared in the cave at the bottom of the dry lakebed at the north pole. It 		happened in an instant, without warning.

​		MELORAE: I turned away from Coleus to examine a sample, and when I turned back, he 			simply wasn't there anymore. He had any limited supply of air, Annona! I'm afraid for him!
...
​		COLEUS: the wandering rock had returned! Never before have I been so delighted to see a 		sedimentary specimen.
...
​		COLEUS: My hypothesis was correct! I can travel on this rock, as long as I'm not observing 		my surroundings  (meaning I must enter in complete darkness). I'm going to bring my 			mentor here to see this.
...
IDEAE: Pye, you know I don't find that funny.

- PYE: How curious; Ramie thinks I'm a gas. And I don't recall requesting that you monitor this conversation, Idaea.

​		IDEAE: I don't see what state of matter you are has to do with this. And I don't recall 				supporting the Sun Station’s construction, but here we are.
...
RAMIE: I imagine our otherwise immensely clever friend Conoy would lose his own head if it weren’t anatomically impossible!



Brittle Hollow Warp Tower
...
- YARROW: My gratitude, Clary! With his, the Ash Twin Project is well underway!
...
​		YARROW: I suppose, more precisely, I would like to visit the station with *you*, Clary

- ​		CLARY: I'd be happy to explain our findings!
  - POKE: Yarrow, stop using this scroll wall to flirt with my sister (in romantic matters, her density rivals a neutron star's) and go and meet her on the White Hole Station.
...
- COLEUS: We’ve also finished relocating all subtareenean plants we met while digging.

​		RAMIE: We’ll need to keep an eye on how significantly we’ve altered the environment here.
...
YARROW: Poke just sent us the warp core for the final warp tower to us from the Black Hole Forge. Now Ash Twin can be connected with Giant’s Deep, where Cassava is working with Avens to craft the Orbital Probe Cannon, and where Phlox is crafting the memory statues.

CASSAVA: Hypothesis: it was not by accident the core of our warp tower was the last to be forged.

POKE: Hypothesis: The cores could have been forged much faster if Cassava had interrupted my work less frequently to ask for updates.

YARROW: The important point is we are all connected through the Ash Twin now, and also that I’m no longer needed for mediating your disagreements.
...
YARROW: We’re nearly ready to activate the Ash Twin Project! Here is what will happen: First, the Sun Station will receive an order to fire at the sun, prompting it to explode.
...
- PYE: Suppose we redesign the Sun Station. To generate a power of that magnitude, a supernova is still our only viable option.
...
{Ash Twin ~ Timber Hearth}

YARROW: My gratitude for the latest shipment, Oeno! This ore should be the last we'll need for the Ash Twin Project.

- YARROW: Once we've finished the shell that seals off the core, we'll check to ensure there are no longer any physical entrances. Ramie and I will be checking the interior for cracks (our final safety check)
...
​		YARROW: We'd be grateful if you would! The more eyes, the better, as the smallest flaw or 		opening in the shell that protects the core could lead to disaster.



{Ash Twin ~ Brittle Hollow}
...
{Ash Twin ~ Probe Tracking Module}
...
OENO: I'm still amazed by how much ore the Ash Twin Project relies!

CYCAD: Isn't this the ore for the remaining towers being built on Ash Twin? The completed towers I've seen are quite large!

OENO: No, the material for those towers is all being taken from Ash Twin. The ore we're mining here will be used to craft an immensely thick protective shell that will physically seal off the Ash twin's core.
...
COLEUS: After closer observation, mining site 2a wouldn't be safe for the native life dwelling in some cave pools, so (unfortunately) we'll have to mine one of the other sites.
...
- COLEUS: On the opposite hand, new life! This species is semi-aquatic, and very hardy. The ecosystem here is quite robust, so I believe they'll thrive in the long run. Be cautious near the pools if you visit 2a to meet them.
  ...
  - COLEUS: They remind me of a subterranean species that my mentor, Melorae, once told me about (from when our clan used to travel across this universe). I am sure she would have enjoyed these lifeforms greatly.

  - CYCAD: I was watching them once during a rest, and the hours escaped from me. They're fascinating (in wonder what their fourth eye does)!

- CYCAD: There are a few other sites that look promising. What about site 2b (it shares similar formations and databases)?
...
​		FILIX: Yes, let's build there! I imagine our young friend Conoy would enjoy that immensely. 		He's always had a great interest in the Eye, especially for a child born so long after the crash.
...
FILIX: No, I… I'm unable to make contact. My equipment can hear the other two escape pod's signals, though. If it's any comfort, both pods must be structurally intact.
...
FILIX: This planet doesn't appear eager to have guests. We are certainly unwelcome on this planet.

THATCH: We need to find shelter, and quickly. The volcanic moon won't be gone for long.

PLUME: I observed several promising sites below the surface, but we'll need to construct a way for everyone to climb safely down this cliff. Perhaps we could safely build platforms?
...
PLUME: The temporary settlement is finished, but remember to be cautious of falling rocks and dust caused by meteor impacts.
...
THATCH: This knowledge is too dear to lose: Here is everything we recall about the signal we encountered while aboard the Vessel.

- FILIX: The signal looked like an eye: Round, with a circle at the centre much like a pupil. (Suppose the signal was looking for something.)
...
KOUSA: We can hear the other escape pod’s distress signals, which gives me hope. Foli, are you still here? I am unsure how to survive in this place without you.
...
PLUME: Given concerns about our settlements stability, where should we construct a new, less temporary shelter?
...
- PLUME: I believe we should migrate to the North glacier.

- THATCH: Building beneath the crust again would shelter us from the volcanic moon's eruptions.
- FILIX: What if we used gravity crystals to craft a stable path?
...
SOLANUM: No one knows how this universe was made, but one thing we do know is everything used to be very hot and dense (tightly packed together).

SOLANUM: As this early universe expanded, it also cooled down. Once it had cooled down enough, particles were able to group together and form things like galaxies, stars and planets!

SOLANUM: Since then, space has continued to grow at a faster and faster rate, which is hard to think about without your brain hurting.
...
- ILEX: Each Nomai clan explores the universe in its own Vessel. The Vessel is in the heart of every clan.
...
- CASSAVA: Even if it no longer functions, the old core would be a valuable blueprint, provided we're able to transport it back here.
...
- PHLOX: This would require a return to Dark Bramble. Plume (my father) said many a good Nomai perished there.
...
- COLEUS: What Melorae and I learned from that fossil would theoretically help us evade the anglerfish, but my hypothesis was never tested on a live specimen.
...
- OENO: The greatest challenge here, I think, is we don't have the original for such a powerful core, or any of the original crafters of the Vessel's core.

CLARY: No, but Poke was apprenticed to Annona, who created the original design, and our Black Hole Forge is adept at crafting similar cores.

POKE: I believe I could be of use here! The Vessel’s warp core was created before my time, but Annona explained many of his designs to me.

\-

POKE: I feel strange, trying to recreate Annona's warp core without him. At times, it feels strange to no longer be his (very young) apprentice, and for the Black Hole Forge to be in my care and not his.

- POKE: Hypothesis: This will always feel strange. Even though my time with him was short, I will always miss my old mentor, and deeply.
...
- POKE: Was I wrong in volunteering to build it...? I was born in this spare system, and never saw Annona's warp core with my own three eyes. I only know what he taught me. What if I've bitten off a larger portion than I can consume?
...
CASSAVA: I should apologise… at least to Clary, who could then tell Poke.
...
- The Eye is older than the universe, so imagine how much it could teach us.
...
- POKE: The white hole cores are for the six warp receivers. Each warp tower leads to a different planet, so that will be a greater pain in your cervical spine (Yarrow knows the exact locations).
...
- PLUME: I'm interested in your playful moon. Is it much like it's violent friend (Hollow’s Lantern)?
...
- POKE: I don't know how close I was to Annona's original design, but as long as what we've built works, then I'm delighted! I knew we could do it (Cassava, I hope you're reading this)!
...
{Brittle Hollow ~ Ember Twin}

PYE: Ramie and I reviewed the records you sent, Poke, and they appear to show the Nomai are arriving at the warp receiver on Brittle Hollow slightly *before* departing from the White Hole Station.
...
- DAZ: Conoy, you should've seen it! We'd thought it was impossible for any canon components to sink even partially below the current, but ours sank straight to the core!
...
CONOY: Cassava's Construction Yard has been using cyclones on Giant's Deep to lift Orbital Pobe Cannon parts into orbit, but one component was pushed past the current that usually prevents anything from sinking.

CONOY: Spire and I are crafting a model to determine why this happened.

SPIRE: An update: It's now clear that there are two different types of cyclone.
...
- CASSAVA: Mallow's idea is clever, but we have no idea where the Eye is in relation to here. The probability of launching a probe in the right direction would be absurdly small.

CONOY: I believe I have a solution to that problem! Have you spoken with Ramie and Pye about the technology they're developing?
...
CASSAVA: Giant’s Deep would be a good choice. It's furthest from the sun, so it would provide the best angles for launch. And it's moonless (except for when the Quantum Moon is visiting).
...
BELLS: The tower is on the opposite side of Brittle Hollow. If you follow the path to the Crossroads, you can reach the tower from there.
...
PLUME: If anyone else witnesses this disturbing behaviour, I implore you, record your observations here. either these trees are aberrant, or my brain must be!
...
FILIX: Hypothesis: This rock shards presence is significant. We should study it! (Could it be what is causing other objects to also move about this area?)
...
FILIX: I've also heard the same signal this shard produces calling from Giant’s Deep, Timber Hearth, and the Hourglass Twins. Suppose there are other shards like this one!

- THATCH: The only other object we've observed displaying this quantum behaviour is the wandering moon. I imagine the moon’s behavior and the grove's are related.
...
BELLS: On your pilgrimage, the Quantum Moon will carry you, just as it carried me and many in our clan before, to the moon's sixth and most secret location.
...
{Hollow’s lantern ~ Timber Hearth}
...
ROOT: it will be *significantly* more. The smallest cracking or opening in the protective shell would destroy everything.
...
SOLANUM: If you’ve come looking for answers, I hope you find them.
...
SOLANUM: I’ve never met with one of your kind before. It’s an honour to speak with you! I particularly admire your four eyes.
...
SOLANUM: Given that the Quantum Moon is the Eye’s moon, it’s likely that any characteristics the moon exhibits are also exhibited by the Eye itself. The Quantum Moon and its shards, for instance, are quantum; thus, the Eye is likely also quantum.

{Eye of the universe + You}

SOLANUM: Many in my clan believed the Eye called to us for a particular purpose.

SOLANUM: When I was a child, I used to believe the Eye was malevolent, to have lured my clan to this star system only to vanish from them so completely.

{Eye of the universe + Identify}

SOLANUM: We are orbiting the Eye of the universe now, although we can not see it (only the Quantum Moon’s reflection of it). The Eye is older than the universe, and my clan believes it dwells in an extremely distant orbit around this star system.

{Eye of the universe + Explain}
...
SOLANUM: The Quantum Moon probably exhibits macroscopic quantum behaviour because of its proximity to the Eye. Shards that broke off from the Quantum Moon have a similar effect, as I imagine you’ve seen elsewhere in this star system.

SOLANUM: Conscious observance forces a quantum object to collapse to a single possibility. But what would happen if a conscious observer somehow entered the Eye itself?

SOLANUM: Over time, this has become my clan’s greatest question.

{You + Identify}

SOLANUM: I am Solanum, a Nomai. My clan arrived in this star system before my birth, and now we call it home.
...
SOLANUM: These are the two tenets of Nomai philosophy; to seek out and understand is our way of living.
...
- CASSAVA: If I'm ever half as gooey as Mallow and Avens behave together, darling, you may launch *me* from the Orbital Probe Cannon.
...
- CASSAVA: I wish I were, my friend, but no. They aren't certain they can fix the problem, so the Orbital Probe Cannon is on an indefinite hiatus.
- CASSAVA: Tell Privet and Mallow they should return from the cannon. Me and Daz will remain at the Construction Yard, for now.
...
DAZ: Each statue will send a single Nomai’s memories to his or her own storage unit within the Ash Twin.
...
{Probe Tracking Module ~ Ash Twin}
...
{Probe Tracking Module ~ Launch Module}

MALLOW: Imagine Privet: The Probe Tracking Module will be held first to know the coordinates of the Eye of the universe! You'll be the first to see them!

PRIVET: I am honoured and terrified!

PRIVET: You won't ask them Orbital Probe Cannon to use so much power that it breaks, will you?

MALLOW: Fret not, my nervous friend! We only need to fire the probe cannon once, anyway, so who minds if it compromises the Orbital Probe Cannon’s structural integrity slightly?
...
- MALLOW: The thought of concluding our elders' curious and challenging search increases my heart's temperature, love!
...
MALLOW: I see! Am I right to think that, consequently, we'll be ignoring that setting?
...
{Launch Module ~ Probe Tracking Module}
...
MALLOW: Yes, the probe must travel as fast as the can, as far as it can. I'll make some adjustments!
...
CLARY: Poke, Pye and I landed here on this comet not long after its arrival in this star system. Our shuttle’s equipment heard strange energy readings coming from somewhere beneath the surface.
...
PYE: This is orders of magnitude worse than I’d imagined. If this stone were to rupture, the lethal matter within would rapidly expand, completely blanketing this star system almost instantaneously. And the pressure is building as the comet approaches the sun...
...
🎥 SECCA: Our escape pod crashed as we tried to flee this place, destroying our movement and communication abilities in the process.

SECCA: We’ve held out for as long as we could here, but this pod’s supply of breathable air is nearly depleted, and the anglerfish attack more and more frequently.
...
ESCALL: We will follow the beacon whose source is closest to us.
...
SECCA: It’s almost too faint to hear now, but the Vessel’s beacon is still faintly emitting from within this thorny seed. Yet the opening is too small for a single Nomai to fit through, so our escape pod couldn’t have flown through here.
...
🎥 FILIX: I’m recording now - I’ve never encountered anything like this! The signal the Vessel is receiving seems to be *older than the universe itself*!
...
ESCALL: We can send the message on arrival. This extraordinary signal appeared suddenly; it may disappear just as quickly, and we can’t lose a discovery this incredible! Focus on preparing for the warp, instead.
...
FILIX: We… we are abandoning our Vessel. Any Nomai clans or spaceflight-capable species receiving, I implore you, we need your help!
...
HYSSOP: It was a very long time ago, but yes. My clan’s ancestors searched for Escall’s clan for a long time, but in the end, none of them were ever seen again. (It’s the only time a Vessel has ever disappeared in this way.)
...
CANNA: I’m relieved your clan is safe, Neem! It’s good to hear your words. Any clan nearby, remember to be extremely cautious of potentially unstable stars (which is most of them, now).